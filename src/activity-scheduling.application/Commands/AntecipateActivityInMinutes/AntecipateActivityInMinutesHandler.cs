...
{
    public class AntecipateActivityInMinutesHandler(IActivityRepository activityRepository) : IRequestHandler<AntecipateActivityInMinutesCommand, GenericCommandResult>
    {
        private readonly IActivityRepository _ActivityRepository = activityRepository;

        public async Task<GenericCommandResult> Handle(AntecipateActivityInMinutesCommand request, CancellationToken cancellationToken)
        {
            ...
            activity.AnticipateActivityInMinutes(request.MinutesToAntecipate);
